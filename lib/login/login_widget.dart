...
class _LoginWidgetState extends State<LoginWidget>
  ...
  void initState() {
    ...
    _model.loginPasswTextController ??= TextEditingController();
    _model.loginPasswFocusNode ??= FocusNode();
  }
            ...
            child: Column(
              ...
              children: [
                ClipRRect(
                  ...
                  child: Image.asset(
                    'assets/images/Screenshot_2025-10-02_165233.png',
                    width: 120.0,
                    fit: BoxFit.contain,
                  ),
                ),
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.loginPasswTextController,
                                        focusNode: _model.loginPasswFocusNode,
                                        autofocus: false,
                                        textInputAction: TextInputAction.done,
                                        obscureText:
                                            !_model.loginPasswVisibility,
                                        decoration: InputDecoration(
                                          isDense: true,
                                          labelStyle: FlutterFlowTheme.of(
                                                  context)
                                        ...
                                        enableInteractiveSelection: true,
                                        validator: _model
                                            .loginPasswTextControllerValidator
                                            .asValidator(context),
                                      ),
                                    ),
                                  ].divide(SizedBox(height: 12.0)),
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          ...
                          final user = await authManager.signInWithEmail(
                            ...
                            _model.loginPasswTextController.text,
                          );
                          if (user == null) {
                            return;
                          }
